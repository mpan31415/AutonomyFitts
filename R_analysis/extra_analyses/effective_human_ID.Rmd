...
######################### scatterplot ######################### 
p <- ggscatter(task_df, x = "eff_human_id", y = "average_mt",
          add = "reg.line",                                 # Add regression line
          conf.int = TRUE,                                  # Add confidence interval
          add.params = list(color = "blue",
                            fill = "lightgray"),
          xlab = "Effective Human Task ID", ylab = "Average Move Time (s)"
          ) 
...
######################### correlation test ######################### 
res <- cor.test(task_df$eff_human_id, task_df$average_mt, 
                    method = "pearson")
res
...
p <- ggscatter(task_df, x = "series_mt", y = "average_mt",
          ...
          add.params = list(color = "blue",
                            fill = "lightgray"),
          xlab = "Series Comb. of Move Times", ylab = "Average Move Time (s)"
          ) 
      # + theme(plot.title = element_text(size = 15, face = "bold"),
      #   axis.title.x = element_text(size = 28, face = "bold"),
      #   axis.title.y = element_text(size = 28, face = "bold"),
...
######################### correlation test ######################### 
res <- cor.test(task_df$series_mt, task_df$average_mt, 
                    method = "pearson")
res
...
p <- ggscatter(task_df, x = "parallel_mt", y = "average_mt",
          ...
          add.params = list(color = "blue",
                            fill = "lightgray"),
          xlab = "Parallel Comb. of Move Times", ylab = "Average Move Time (s)"
          ) 
      # + theme(plot.title = element_text(size = 15, face = "bold"),
      #   axis.title.x = element_text(size = 28, face = "bold"),
      #   axis.title.y = element_text(size = 28, face = "bold"),
...
######################### correlation test ######################### 
res <- cor.test(task_df$parallel_mt, task_df$average_mt, 
                    method = "pearson")
res
