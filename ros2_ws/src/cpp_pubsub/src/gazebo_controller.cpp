...
public:
  ...
  { 
    ...
    controller_timer_ = this->create_wall_timer(2ms, std::bind(&GazeboController::controller_publisher, this));    // controls at 500 Hz
    ...
    "curr_target_id", 10, std::bind(&GazeboController::incoming_target_id_callback, this, std::placeholders::_1));

    // create the ring_finished flag subscriber
    ring_finished_sub_ = this->create_subscription<std_msgs::msg::Bool>(
    "ring_finished", 10, std::bind(&GazeboController::ring_finished_callback, this, std::placeholders::_1));
...
private:
  ...
  { 
    ...
    if (initial_joint_vals_count < required_initial_vals) {
      initial_joint_vals.at(0) = data.at(0);
      initial_joint_vals.at(1) = data.at(1);
      initial_joint_vals.at(2) = data.at(7);
      initial_joint_vals.at(3) = data.at(2);
      initial_joint_vals.at(4) = data.at(3);
      initial_joint_vals.at(5) = data.at(4);
      initial_joint_vals.at(6) = data.at(5);
